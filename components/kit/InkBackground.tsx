 ...
 * the --ink-* tokens defined in theme.css. Each bloom also drifts slightly toward
 * the cursor (depth-scaled parallax); the auto drift keyframes stay on the inner
    ...
    const handleMove = (e: MouseEvent) => {
      ...
      frame = requestAnimationFrame(() => {
        wrapRefs.current.forEach((el, i) => {
          if (!el) return;
          const depth = INK_BLOOMS[i].depth;
          const x = nx * MAX_PARALLAX_PX * depth;
          const y = ny * MAX_PARALLAX_PX * depth;
