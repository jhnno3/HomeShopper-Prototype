...
// accepts for link mode — a 다방 listing link — or rejects it with a
...
//
// Address input is handled separately by the caller and never reaches here;
// this module only ever sees input the user submitted in link mode.
