...
function InkField() {
  return (
    <div className="v3-ink" aria-hidden>
      {INK_BLOOMS.map((b, i) => (
        <div
          key={i}
      ...
      <header className="g-navbar sticky top-0 z-40">
        <div className="mx-auto flex max-w-5xl items-center justify-between px-4 py-3 sm:px-6">
          ...
          <nav className="flex items-center gap-2">
            ...
            <a href="#" className="g-cta px-4 py-2 text-sm">
              무료 분석
            </a>
          </nav>
        </div>
          ...
          <Reveal delay={0.1}>
            <div className="g-panel g-window relative">
              ...
              <div className="absolute inset-x-0 bottom-0 top-11 flex items-center justify-center">
                <a href="#" className="g-chip flex items-center gap-2 rounded-full px-5 py-2.5 text-[14px] font-bold text-(--royal-deep)">
      ...
      <section className="px-4 pb-20 pt-4 sm:pb-28">
        <Reveal>
          <div className="g-banner mx-auto flex max-w-5xl flex-col items-start gap-6 p-8 sm:flex-row sm:items-center sm:justify-between sm:p-10">
            ...
            <a href="#" className="g-banner-cta shrink-0 px-6 py-3.5 text-[15px]">
              사전예약 하기
            </a>
          </div>
        </Reveal>
